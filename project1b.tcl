...
set val(x)	   			350						   ;# X-dimension
set val(y)				150						   ;# Y-dimension

# Initialize Global Variables
set ns		[new Simulator]


set tracefile     [open Pkt-$argv-project1b_trace.tr w]
$ns trace-all $tracefile

set namtrace [open Pkt-$argv-project1b.nam w]
...
$node_(17) set X_ 150.0
$node_(17) set Y_ 150.0
$node_(17) set Z_ 0.0
$node_(17) color "black"

$node_(18) set X_ 200.0
$node_(18) set Y_ 150.0
$node_(18) set Z_ 0.0
$node_(18) color "black"

$node_(19) set X_ 250.0
$node_(19) set Y_ 150.0
$node_(19) set Z_ 0.0
$node_(19) color "black"

$node_(20) set X_ 300.0
$node_(20) set Y_ 150.0
$node_(20) set Z_ 0.0
$node_(20) color "black"

$node_(21) set X_ 350.0
$node_(21) set Y_ 150.0
$node_(21) set Z_ 0.0
...
$cbr2 set type_ CBR
$cbr2 set packet_size_ $argv
$cbr2 set rate_ 70Kb
$cbr2 set random_ false

#Pair 3
set udp3 [new Agent/UDP]
$ns attach-agent $node_(17) $udp3
set null3 [new Agent/Null]
$ns attach-agent $node_(10) $null3
...
$ns attach-agent $node_(11) $null4
...
$cbr4 set type_ CBR
$cbr4 set packet_size_ $argv
$cbr4 set rate_ 70Kb
$cbr4 set random_ false

#Pair 5
set udp5 [new Agent/UDP]
$ns attach-agent $node_(11) $udp5
set null5 [new Agent/Null]
$ns attach-agent $node_(12) $null5
...
$cbr5 set type_ CBR
$cbr5 set packet_size_ $argv
$cbr5 set rate_ 70Kb
$cbr5 set random_ false

#Pair 6
set udp6 [new Agent/UDP]
$ns attach-agent $node_(5) $udp6
...
$cbr6 set type_ CBR
$cbr6 set packet_size_ $argv
$cbr6 set rate_ 70Kb
$cbr6 set random_ false

#Pair 7
set udp7 [new Agent/UDP]
$ns attach-agent $node_(14) $udp7
set null7 [new Agent/Null]
$ns attach-agent $node_(21) $null7
...
$cbr7 set type_ CBR
$cbr7 set packet_size_ $argv
$cbr7 set rate_ 70Kb
$cbr7 set random_ false

#Pair 8
set udp8 [new Agent/UDP]
$ns attach-agent $node_(13) $udp8
set null8 [new Agent/Null]
$ns attach-agent $node_(14) $null8
...
$ns attach-agent $node_(16) $null9
...
$ns at 12.0 "$cbr3 start"
$ns at 20.0 "$cbr4 start"
$ns at 30.0 "$cbr5 start"
$ns at 10.0 "$cbr6 start"
$ns at 5.0 "$cbr7 start"
$ns at 12.0 "$cbr8 start"
$ns at 6.0 "$cbr9 start"

$ns at 40.0 "$cbr1 stop"
$ns at 55.0 "$cbr2 stop"
$ns at 30.0 "$cbr3 stop"
$ns at 55.0 "$cbr4 stop"
$ns at 45.0 "$cbr5 stop"
$ns at 50.0 "$cbr6 stop"
$ns at 49.0 "$cbr7 stop"
$ns at 30.0 "$cbr8 stop"
$ns at 47.0 "$cbr9 stop"
...
$ns at 60.0 "stop"
$ns at 60.01 "puts \"NS EXITING...\" ; $ns halt"
